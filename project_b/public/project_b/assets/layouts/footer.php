<footer>
    ...
    <div class="row">
        <div class="col-md-3 col-sm-12 mb-3 text-center">
            <defs>
                <img src="<?php echo base_url()?>project_b/assets/images/innsight_logo.png" width="100" height="100" alt="innsight_logo">
        ...
        <div class="col-md-9 col-sm-12">
            ...
            <ul class="list-group">
            <li class="list-group-item bg-transparent border-0 p-0 mb-2"><a href="https://shashank01k.github.io/galaxy-programmer/"></i> Blog</a></li>
            </ul>
            </div>
            ...
            <li class="list-group-item bg-transparent border-0 p-0 mb-2">
                <a href="https://www.linkedin.com/in/shashank-pandey-3123b51b4/"><i class="fa fa-linkedin mr-1"></i> LinkedIn</a>
            </li>
            <li class="list-group-item bg-transparent border-0 p-0 mb-2">
                <a href="https://twitter.com/01k_shashank"><i class="fa fa-twitter mr-1"></i> Twitter</a>       
            </li class="list-group-item bg-transparent border-0 p-0 mb-2">
            <li class="list-group-item bg-transparent border-0 p-0 mb-2"> 
                <a href="https://www.reddit.com/user/AromaticIndividual19/"><i class="fa fa-reddit mr-1"></i> Reddit</a>
            </li>
            <li class="list-group-item bg-transparent border-0 p-0 mb-2">
                <a href="https://github.com/Shashank01k" target="_blank"><i class="fa fa-github mr-1"></i> Github</a>  
            </li>
            </ul>
            </div>
        ...
        <div class="col-md-12">
            ...
            <p>
                Copyright &copy 2024 <a class="mr-4" href="<?php echo base_url()?>terms">Privacy & terms</a>
            </p>
            </div>
        </div>
    </div>
